...
class SongUpload(Song):
    def __init__(self, name, path, artist, genre): #name is the song title
        super().__init__(name, path, artist, genre)
        self._info = {}
        self._file_name = ""
        self._file_path = ""
        self.publish()
